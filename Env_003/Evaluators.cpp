...
void Env_Room_Putter::UpdateScores()
{
...
bool Env_Room_Putter::CheckAvailableSpaceUsed() {
...
bool Env_Room_Putter::CheckCirculationAccessToOutside() {
	Scores.CirculationAccessToOutside = (CirculationAccessToOutside? ALPHA : 0) + BETA;
	return true;
}

bool Env_Room_Putter::CheckAllRoomsConnectedToCirculation(){
